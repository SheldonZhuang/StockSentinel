...
- 全面防守期月均收益：**-0.7%**（79 个月）｜减仓观望期：**1.1%**（165 个月）｜其余：**1.5%**（73 个月）
- **全面防守占比：25%**，减仓观望占比：52%（防守分级后，单维收紧不再全仓防守）
- 全期（26.4年）：买入持有 年化 8.5%、最大回撤 -50.8%；策略（仅defense离场，defense月计现金利息）年化 12.2%、最大回撤 -16.2%
- **敏感性（照档位建议执行）**："reduce=50%仓"策略（reduce 月 50% SPY + 50% 现金利息；defense 月全现金；其余满仓）：年化 9.1%、最大回撤 -10.6%——与上行"仅defense离场"口径并列，反映严格按档位执行的真实预期
- **子样本稳健性（2010-01 起，16.4年）**：策略年化 12.9%（最大回撤 -16.2%）vs 买入持有年化 14.6%（最大回撤 -23.9%）——策略的超额收益高度依赖起点包含 2000 年泡沫顶；后半段策略主要贡献是降回撤而非增收益
- 各维度收紧月数：货币 40、财政 89、行政 85；锁激活 61 个月
- 防守信号片段共 **8** 段，其中 **6** 段未伴随随后12个月内 >15% 的回撤（假阳性率 75%）
...
6. **假阳性为保守上界**：假阳性判定用月末采样价，月中盘中出现过 >15% 但月末收复的回撤会被漏计，75% 是保守上界。
...
2. **防守分级已生效（2026-07-12 用户拍板）**：单维收紧=减仓观望（部分仓位），双维共振或锁=全面防守（空仓/对冲）。全面防守占比 25%（分级前为 74%），大量单维噪声月份降级为减仓观望。
3. **精确率仍是主要代价**：75% 的防守片段未跟随大回撤，防守期月均收益 -0.7%（为负，防守有效规避了下跌；vs 非防守 1.5%）。若严格按信号空仓执行会错过部分上涨月份。
