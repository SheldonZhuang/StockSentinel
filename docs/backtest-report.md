...
- 全面防守期月均收益：**-0.2%**（97 个月）｜减仓观望期：**1.2%**（136 个月）｜其余：**1.3%**（85 个月）
- **全面防守占比：31%**，减仓观望占比：43%（防守分级后，单维收紧不再全仓防守）
- 各维度收紧月数：货币 22、财政 158、行政 98；锁激活 59 个月
- 防守信号片段共 **27** 段，其中 **22** 段未伴随随后12个月内 >15% 的回撤（假阳性率 81%）
...
3. **精确率仍是主要代价**：81% 的防守片段未跟随大回撤，防守期月均收益 -0.2%（为负，防守有效规避了下跌；vs 非防守 1.3%）。若严格按信号空仓执行会错过部分上涨月份。
