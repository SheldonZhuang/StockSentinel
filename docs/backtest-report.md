...
- 全面防守期月均收益：**-0.3%**（94 个月）｜减仓观望期：**1.2%**（138 个月）｜其余：**1.3%**（86 个月）
- **全面防守占比：30%**，减仓观望占比：43%（防守分级后，单维收紧不再全仓防守）
- 各维度收紧月数：货币 22、财政 158、行政 92；锁激活 59 个月
- 防守信号片段共 **24** 段，其中 **19** 段未伴随随后12个月内 >15% 的回撤（假阳性率 79%）
...
2. **防守分级已生效（2026-07-12 用户拍板）**：单维收紧=减仓观望（部分仓位），双维共振或锁=全面防守（空仓/对冲）。全面防守占比 30%（分级前为 74%），大量单维噪声月份降级为减仓观望。
3. **精确率仍是主要代价**：79% 的防守片段未跟随大回撤，防守期月均收益 -0.3%（为负，防守有效规避了下跌；vs 非防守 1.3%）。若严格按信号空仓执行会错过部分上涨月份。
