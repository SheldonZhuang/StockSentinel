...
生成时间：2026-07-17 ｜ 数据源：FRED（利率 DFEDTAR+DFEDTARU 拼接、WALCL、MTSDS133FMS、EPUTRADE、SAHMREALTIME）｜ 标普500：Tiingo SPY 总回报（adjClose，含股息复权）
...
| 2020 新冠崩盘 | 2020-02-19 | 2020-03-23 | -33.7% | 2019-10 | 提前111天 | -10.8% | -25.7% | 2019-12 | 决策树 |
...
- 全面防守期月均收益：**-0.3%**（92 个月）｜减仓观望期：**1.3%**（125 个月）｜其余：**1.1%**（101 个月）
- **全面防守占比：29%**，减仓观望占比：39%（防守分级后，单维收紧不再全仓防守）
- 各维度收紧月数：货币 40、财政 89、行政 92；锁激活 59 个月
