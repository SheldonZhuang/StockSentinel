...
生成时间：2026-07-12 ｜ 数据源：FRED（利率 DFEDTAR+DFEDTARU 拼接、WALCL、MTSDS133FMS、EPUTRADE、SAHMREALTIME）｜ 标普500：Tiingo SPY（标普500 ETF 代理）（本地缓存）
...
- 全面防守期月均收益：**0.1%**（145 个月）｜减仓观望期：**1.2%**（93 个月）｜其余：**1.0%**（80 个月）
- **全面防守占比：46%**，减仓观望占比：29%（防守分级后，单维收紧不再全仓防守）
- 各维度收紧月数：货币 117、财政 153、行政 98；锁激活 59 个月
- 防守信号片段共 **24** 段，其中 **20** 段未伴随随后12个月内 >15% 的回撤（假阳性率 83%）
...
3. **精确率仍是主要代价**：83% 的防守片段未跟随大回撤，防守期月均仍有 0.1% 正收益（vs 非防守 1.0%）。若严格按信号空仓执行会错过大量上涨月份。
