...
| 行政政策 | FRED `EPUTRADE`（月度贸易专项）+ `USEPUINDXD`（日频EPU 7日均线）+ `DCOILWTICO`（WTI油价，战争冲击实时代理） | 油价30天涨跌 ≥±20% 事件层优先：飙升=战争/供给冲击→立即收紧，暴跌=战争结束/降级→立即宽松；否则EPU双源10年百分位 >80→收紧，<50→宽松，一致才定档 |
